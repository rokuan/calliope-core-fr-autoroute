...
/**
  ...
  */
class SimpleWordMatcher(val types: Array[WordType], val regex: String) extends WordMatcher[Word] {
...
class SimpleWordMatcherBuilder {
  private var types: Array[WordType] = Array()
  private var regex: String = null

  def setTypes(wordTypes: WordType*) = { types = wordTypes.toArray; this }
